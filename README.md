...
Shadow SMS is a small bash script that using the API -textbelt- allows us to send SMS to any phone number in any country anonymously and totally untraceable.
